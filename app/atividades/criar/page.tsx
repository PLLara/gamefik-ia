  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-background">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Right - Preview Area */}
        <div className="flex w-[420px] flex-col border-l border-border bg-muted/30">
          {/* Preview Header */}
          <div className="flex items-center justify-between border-b border-border px-4 py-3">
            <div className="flex items-center gap-2">
              <Eye className="h-4 w-4 text-muted-foreground" />
              <span className="text-sm font-medium text-foreground">Visualizacao do aluno</span>
              <span className="text-xs text-muted-foreground">— clique em Editar para personalizar</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="relative w-[280px]">
              ...
              <div className="overflow-hidden rounded-[2.5rem] border-[8px] border-foreground/90 bg-foreground/90 shadow-2xl">
                ...
                <div className="bg-card">
                  {/* Quiz Image */}
                  <div className="relative h-32 w-full bg-gradient-to-br from-primary/20 to-primary/40">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex -space-x-4">
                        <div className="h-16 w-16 rounded-full bg-amber-400 border-2 border-white" />
                        <div className="h-16 w-16 rounded-full bg-emerald-400 border-2 border-white" />
                        <div className="h-16 w-16 rounded-full bg-rose-400 border-2 border-white" />
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Quiz Info */}
                  <div className="p-4">
                    <h3 className="mb-3 text-center text-base font-bold text-primary">
                    ...
                    <div className="mb-3 flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-semibold text-foreground">Professor Gamefik</p>
                      </div>
                    </div>

                    {/* Description */}
                    <div className="mb-3">
                      <p className="mb-1 text-xs font-semibold text-foreground">Descricao</p>
                    ...
                    {/* Tip */}
                    <div className="mb-4 flex items-start gap-2 rounded-lg bg-amber-50 p-2.5">
                    ...
                    {/* Play Button */}
                    <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 py-3 text-sm font-bold text-white">
                      Jogar este Quiz
            ...
            {showClassDropdown && (
              <>
                ...
                <div className="absolute bottom-full left-0 z-50 mb-2 w-48 rounded-xl border border-border bg-card p-1 shadow-lg">
                  {["Todas as turmas", "6 Ano A", "6 Ano B", "7 Ano A", "7 Ano B"].map((turma) => (
                    <button
                      key={turma}
                      onClick={() => setShowClassDropdown(false)}
