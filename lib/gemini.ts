...
export const GEMINI_FALLBACK_MODEL = process.env.GEMINI_FALLBACK_MODEL?.trim() || "gemini-2.0-flash"
export const GEMINI_FAST_MODEL = process.env.GEMINI_FAST_MODEL?.trim() || "gemini-2.0-flash"
